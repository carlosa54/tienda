...
from carts.views import CartView, CartTotalView, ItemCountView, CheckoutView, CheckoutFinalView, OrderList, OrderDetail, CartAPIView, CheckoutAPIView, CheckoutFinalizeAPIView
from orders.views import AddressSelectFormView, UserAddressCreateView, UserShipAddressCreateView, UserCheckoutAPI, UserAddressCreateAPIView, UserAddressListAPIView, OrderListAPIView, OrderRetrieveAPIView
from dashboard.views import DashboardView
from reports.views import OrdersAuditView
from products.views import CategoryListAPIView, CategoryRetrieveAPIView, ProductListAPIView, ProductRetrieveAPIView, APIHomeView
...
urlpatterns = [
    ...
    url(r'^stores/', include('products.urls_stores')),
    url(r'^categories/', include('products.urls_categories')),
    url(r'^orders/$', OrderList.as_view(), name='orders'),
    url(r'^orders/(?P<pk>\d+)/$', OrderDetail.as_view(), name='order_detail'),
    url(r'^cart/$', CartView.as_view(), name='cart'),
    url(r'^cart/count/$', ItemCountView.as_view(), name='item_count'),
    url(r'^cart/total/$', CartTotalView.as_view(), name='cart_total'),
    url(r'^checkout/$', CheckoutView.as_view(), name='checkout'),
    url(r'^checkout/address/$', AddressSelectFormView.as_view(), name='order_address'),
    url(r'^checkout/address/add$', UserAddressCreateView.as_view(), name='user_address_create'),
    url(r'^checkout/address/addship$', UserShipAddressCreateView.as_view(), name='user_shipaddress_create'),
    url(r'^checkout/final$', CheckoutFinalView.as_view(), name='checkout_final'),
    url(r'^reports/$', OrdersAuditView.as_view(), name='audit'),
    url(r'^dash/$', DashboardView.as_view() , name='dash'),
